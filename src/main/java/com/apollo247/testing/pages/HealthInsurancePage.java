...
//		    By element = (By.xpath("//button[normalize-space()='"+gender+"']"));
//		    ((WebElement) element).click();
//		}
//		public void selectMember(String member) {
//			By element=(By.xpath("//span[.='"+member+"']"));
//			((WebElement)element).click();
//		}
		...
		public void performViewPlans() {
		 ...
		 public void selectGender(String gender) {
		        WebElement element =driver.findElement(By.xpath("//button[normalize-space()='"+gender+"']"));
		            
		        element.click();
		    }

		    public void selectMember(String member) {
		        WebElement element = driver.findElement(By.xpath("//span[.='"+member+"']"));
		        element.click();
		    }
		    
//		    public void clickViewButton(String viewPlans) {
//		    	 WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
//
//		    	    WebElement button = wait.until(
//		    	        ExpectedConditions.elementToBeClickable(
//		    	            By.xpath("//span[normalize-space()='View Plans']")
//		    	        )
//		    	    );
//
//		    	    button.click();
